...
/*   Updated: 2019/08/28 17:06:10 by aorji            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
**	A 128-bit representation of the length of the message before
**	the padding bits were added
**  is appended to the result of step 1 ==> 16 bytre
*/
...
**	len = 896 mod 1024 (in bytes: len = 112 mod 1024) => len = a mod n
*/

static const int		g_n = 128;
static const int		g_a = 112;

void					calculation_procedure_64(void *message,\
int block_num, uint64_t h[]);
